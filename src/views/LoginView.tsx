...
import { getActiveMode, DatabaseMode } from '../dbService';
    ...
    <div className="min-h-screen bg-[#070b19] text-white flex flex-col justify-between items-center px-4 py-6 relative overflow-y-auto">
      ...
      <div className="w-full max-w-sm bg-[#0f172a] border border-slate-800 rounded-3xl p-6 relative z-10 shadow-2xl my-auto animate-fade-in">
        ...
        <button
          ...
          className="w-full bg-slate-900 hover:bg-slate-850 tracking-wide text-white border border-slate-800 font-bold py-3 px-4 rounded-xl transition duration-150 text-xs flex items-center justify-center gap-2 shadow-sm cursor-pointer"
